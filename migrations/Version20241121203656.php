 ...
 */
final class Version20241121203656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE instrument (id INT AUTO_INCREMENT NOT NULL, name TINYTEXT NOT NULL, model TINYTEXT NOT NULL, created_at DATE NOT NULL, description LONGTEXT NOT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
